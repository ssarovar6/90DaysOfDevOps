...
**Document:** What is the difference between a "root module" and a "child module"? ans =  The root module is the main directory where you run commands (terraform plan/apply), acting as the entry point. Child modules are called by the root module to package reusable, encapsulated components of infrastructure

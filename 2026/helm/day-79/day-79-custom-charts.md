...
Note for Me - I have recreated values.yaml with only contents from above and removed other pre-contents hence getting error as - [ERROR] templates/: template: bankapp/templates/NOTES.txt:2:14: executing "bankapp/templates/NOTES.txt" at <.Values.httpRoute.enabled>: nil pointer evaluating interface {}.enabled
Error: 1 chart(s) linted, 1 chart(s) failed

to resolve added these 2 lines in values.yaml file  - 
ingress.enabled:false , httpRoute.enabled:false

also in NOTES.txt modified line Values.bankapp.service.type
